...
def main():
    ...
    env = UnityEnvironment(file_name=ENV_PATH, worker_id=0, no_graphics=NO_GRAPHICS, side_channels=[engine_config_channel])
    env.reset()
    ...
    for step in range(START_TRAINING_STEPS + 1, END_TRAINING_STEPS + 1):
        total_steps += 1
        episode_steps += 1
